...
exports.strategySkillRequirements = (0, pg_core_1.pgTable)('strategy_skill_requirements', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    tenantId: (0, pg_core_1.uuid)('tenant_id').notNull().references(() => core_1.tenants.id, { onDelete: 'cascade' }),
    strategyId: (0, pg_core_1.uuid)('strategy_id'), // Link to strategy if exists
...
exports.skillsGapAnalysis = (0, pg_core_1.pgTable)('skills_gap_analysis', {
    ...
    tenantId: (0, pg_core_1.uuid)('tenant_id').notNull().references(() => core_1.tenants.id, { onDelete: 'cascade' }),
    employeeId: (0, pg_core_1.uuid)('employee_id').notNull(),
    profileId: (0, pg_core_1.uuid)('profile_id').notNull(), // Links to employeeSkillsProfiles
    // Analysis results
...
exports.skillsReports = (0, pg_core_1.pgTable)('skills_reports', {
    ...
    targetId: (0, pg_core_1.uuid)('target_id'), // employeeId, departmentId, or tenantId
...
exports.skillsReAnalysisQueue = (0, pg_core_1.pgTable)('skills_reanalysis_queue', {
    ...
    tenantId: (0, pg_core_1.text)('tenant_id').notNull(),
    employeeId: (0, pg_core_1.text)('employee_id').notNull(),
    reason: (0, pg_core_1.text)('reason').notNull(), // 'time-based' | 'role-change' | 'strategy-update' | 'learning-completion'
    status: (0, pg_core_1.text)('status', { enum: ['pending', 'processing', 'completed', 'failed'] }).default('pending'),
    triggeredBy: (0, pg_core_1.text)('triggered_by'), // 'system' | userId
...
exports.employeeRoleHistory = (0, pg_core_1.pgTable)('employee_role_history', {
    ...
    changeReason: (0, pg_core_1.text)('change_reason'), // 'promotion' | 'transfer' | 'restructure'
...
exports.learningProgressEvents = (0, pg_core_1.pgTable)('learning_progress_events', {
    ...
    tenantId: (0, pg_core_1.text)('tenant_id').notNull(),
    employeeId: (0, pg_core_1.text)('employee_id').notNull(),
    eventType: (0, pg_core_1.text)('event_type').notNull(), // 'enrollment' | 'progress' | 'completion'
    learningPathId: (0, pg_core_1.text)('learning_path_id'),
    courseId: (0, pg_core_1.text)('course_id'),
    skillsAcquired: (0, pg_core_1.jsonb)('skills_acquired'), // Array of skills acquired
    completionPercentage: (0, pg_core_1.integer)('completion_percentage').default(0),
...
exports.skills = (0, pg_core_1.pgTable)('skills', {
    ...
    userSkillUnique: (0, pg_core_1.uniqueIndex)('idx_skills_user_id_name_unique').on(table.userId, table.name),
}));
