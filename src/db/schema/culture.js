...
exports.cultureAssessments = (0, pg_core_1.pgTable)('culture_assessments', {
    ...
    companyId: (0, pg_core_1.uuid)('company_id'), // Reference to company/tenant
...
exports.cultureReports = (0, pg_core_1.pgTable)('culture_reports', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    tenantId: (0, pg_core_1.uuid)('tenant_id').notNull().references(() => core_1.tenants.id, { onDelete: 'cascade' }),
    analysisId: (0, pg_core_1.uuid)('analysis_id'),
...
exports.cylinderScores = (0, pg_core_1.pgTable)('cylinder_scores', {
    ...
    targetId: (0, pg_core_1.uuid)('target_id').notNull(), // userId, departmentId, or companyId
    assessmentId: (0, pg_core_1.uuid)('assessment_id'), // Reference to culture assessment
