...
exports.paymentSessions = exports.demoRequests = exports.invoices = exports.subscriptions = exports.payments = void 0;
...
exports.paymentSessions = (0, pg_core_1.pgTable)('payment_sessions', {
    ...
    stripeSessionId: (0, pg_core_1.text)('stripe_session_id').unique().notNull(),
    // Session details
    amount: (0, pg_core_1.integer)('amount').notNull(), // in cents
    currency: (0, pg_core_1.text)('currency').notNull().default('usd'),
