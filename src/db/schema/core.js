...
exports.tenants = (0, pg_core_1.pgTable)('tenants', {
    ...
    marketPosition: (0, pg_core_1.text)('market_position'), // Market position (leader, challenger, follower, nicher)
    location: (0, pg_core_1.text)('location'), // Company location/headquarters
...
exports.departments = (0, pg_core_1.pgTable)('departments', {
    ...
    managerId: (0, pg_core_1.uuid)('manager_id'),
    parentDepartmentId: (0, pg_core_1.uuid)('parent_department_id'),
...
exports.structureAnalysisResults = (0, pg_core_1.pgTable)('structure_analysis_results', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    tenantId: (0, pg_core_1.uuid)('tenant_id').notNull().references(() => exports.tenants.id, { onDelete: 'cascade' }),
    analysisId: (0, pg_core_1.uuid)('analysis_id').notNull(),
